...
let TokenEndpointUrl =
    "https://sso-dev.pathfinder.gov.bc.ca/auth/realms/ff09qn3f/protocol/openid-connect/token";
let ServiceEndPointUrl =
    "https://dev.healthgateway.gov.bc.ca/api/immunizationservice/v1/api/Immunization";
