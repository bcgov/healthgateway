...
let TokenEndpointUrl =
    "https://sso-" +
    environment +
    ".pathfinder.gov.bc.ca/auth/realms/ff09qn3f/protocol/openid-connect/token";
let ServiceEndPointUrl =
    "https://" +
    environment +
    ".healthgateway.gov.bc.ca/api/patientservice/v1/api/Patient";
...
export default function () {
    ...
    console.log("Patient for username: " + user.username);
