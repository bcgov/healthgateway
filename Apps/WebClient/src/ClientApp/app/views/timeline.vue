...
<template>
    <div>
            ...
            <b-col id="timeline" class="col-12 col-md-8 col-lg-6 column-wrapper">
                ...
                <b-alert :show="unverifiedEmail"
                    ...
                    <span>
                        ...
                        folder for an email from Health Gateway.  Alternatively,
                        <router-link id="profilePageLink"
                                     variant="primary"
                                     to="/profile">
                            edit your profile or resend the email
                        </router-link>.
                    </span>
                </b-alert>
                <div id="pageTitle">
        ...
        <ProtectiveWordComponent ref="protectiveWordModal"
