        ...
        <b-row>
            <b-col>
                <form>
                    <b-row>
                        <b-col>
                            <label for="verificationCode-input">Verification Code sent to <strong>{{ smsNumber }}</strong></label>
                            <b-form-input id="verificationCode-input"
                    ...
                    <b-row v-if="error">
                        <b-col>
                            <span class="text-danger">Invalid verification code. Try again.</span>
                        </b-col>
                    </b-row>
                </form>
            </b-col>
