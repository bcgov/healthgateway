  ...
  <b-navbar toggleable="lg" type="dark">
    ...
    <b-collapse id="nav-collapse" is-nav>
      ...
      <b-navbar-nav class="ml-auto">
          <b-nav-item-dropdown v-if="oidcIsAuthenticated"
                               id="menuBtndUser"
                               :text="greeting"
                               right
                               variant="dark">
              ...
              <b-dropdown-item v-if="displayMenu" href="https://github.com/bcgov/healthgateway/wiki">
                  <a href="https://github.com/bcgov/healthgateway/wiki" target="_blank">
...
import { faStream, faSignOutAlt, faInfoCircle } from "@fortawesome/free-solid-svg-icons";
