...
export const actions: ErrorBannerActions = {
    ...
    clearTooManyRequestsWarning(context) {
        context.commit("clearTooManyRequestsWarning");
    },
    clearTooManyRequestsError(context) {
        context.commit("clearTooManyRequestsError");
    },
};
