...
export default class BcCancerScreeningTimelineEntry extends TimelineEntry {
    ...
    private static readonly programResultTitleMap: Record<string, string> = {
        "cervical cancer": "BC Cancer Cervical Screening Result Letter",
        "breast cancer": "BC Cancer Screening | Breast Screening Result Letter",
    ...
    private static readonly programReminderTitleMap: Record<string, string> = {
        "cervical cancer": "BC Cancer Cervical Screening Reminder Letter",
        "breast cancer": "BC Breast Cancer Reminder Letter",
