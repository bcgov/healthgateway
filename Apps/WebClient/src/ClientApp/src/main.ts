...
import HgIcon from "@/components/shared/hgIcon.vue";
import PageTitle from "@/components/shared/pageTitle.vue";
import StatusLabel from "@/components/shared/statusLabel.vue";
...
Vue.component("HgButton", HgButton);
Vue.component("HgIcon", HgIcon);
