...
<template>
    <div class="flex-grow-1 d-flex flex-column">
        ...
        <div class="hg-profile m-3 m-md-4 flex-grow-1">
            <b-alert
            ...
            >
                ...
                <span>
                    Please check your email for an email verification link. If
                    you didn't receive one, please check your junk mail.
                </span>
            </b-alert>
                            ...
                            <b-row v-if="showCloseWarning" class="mb-3">
                                ...
                                >
                                    ...
                                    <span
                                        ...
                                        removal, preventing you from accessing
                                        your information on the Health Gateway.
                                        After a set period of time it will be
