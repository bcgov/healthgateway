...
const immunizationsAreLoading = computed<boolean>(() =>
    store.getters["vaccinationStatus/immunizationsAreLoading"](user.value.hdid)
);
const immunizationsAreDeferred = computed<boolean>(() =>
    store.getters["vaccinationStatus/immunizationsAreDeferred"](user.value.hdid)
);
const covidImmunizations = computed<ImmunizationEvent[]>(() =>
    store.getters["vaccinationStatus/covidImmunizations"](user.value.hdid)
);
const immunizationsError = computed<ResultError | undefined>(() =>
    store.getters["vaccinationStatus/immunizationsError"](user.value.hdid)
);
