...
const isSidebarVisible = computed(() => !currentPathMatches(Path.VppLogin));
...
<template>
    <v-app>
        ...
        <SidebarComponent v-if="isSidebarVisible" />
        ...
        <v-main class="position-relative">
            ...
            <router-view v-if="currentPathMatches(Path.VppLogin)" />
