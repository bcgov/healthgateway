...
/* AB#16927 Disable notifications 
...
/* AB#16927 Updates to HGW Classic 
...
<template>
    ...
    >
        ...
        <v-spacer />
        <!-- AB#16927 Disable app tour <AppTourComponent
        ...
        /> -->
        <!-- AB#16927 Disable notifications <HgIconButtonComponent
