        ...
        <b-row class="entryHeading px-2 py-3">
            ...
            <b-col class="entryTitle">
                <b-row class="justify-content-between">
                    <b-col data-testid="laboratoryTitle">
                            ...
                            <div class="detailSection">
                                ...
                                >
                                    ...
                                    <div class="my-2">
                                        ...
                                        <p
                                            v-html="result.resultDescription"
                                        ></p>
                                    </div>
                                    <div>
                            ...
                            <div class="detailSection">
                                <div>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            Public health will contact you in 2
                                            to 3 days with further instructions.
                                        </li>
                                        <li>
                                            If you are a health care worker,
                                            please notify your employer of your
                                            positive result.
                                        </li>
                                        <li>
                                            Monitor your health and contact a
                                            health care provider or call 8-1-1
