            ...
            >
                ...
                <v-carousel-item v-for="tile in accessLinks" :key="tile.name">
                    <v-card
                        ...
                        rounded="md"
                        :class="[
                            'landing-primary-override h-100 d-flex flex-column text-start pa-5 pa-lg-4 border-sm',
            ...
            <v-row v-else align="stretch" class="mb-6 mb-md-8">
                ...
                >
                    <v-card
                        variant="outlined"
                        rounded="md"
                        class="landing-primary-override h-100 d-flex flex-column text-start pa-5 pa-lg-4 border-sm"
