    ...
    <div>
        ...
        <div ref="report">
            <section class="pdf-item">
                <div id="pageTitle">
                    <h3 id="subject">
                        Health Gateway Medication History Report
                    </h3>
                </div>
                <div id="disclaimer" class="mr-1">
                    Disclaimer: This report was generated by the Health Gateway
                    and does not serve as the legal record of dispensed
                    medication history for this individual.
                </div>
                <hr class="mb-0" />
                <b-row class="pt-2">
                    <b-col>
