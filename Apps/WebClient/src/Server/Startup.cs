...
#pragma warning restore S1075
        ...
        private static void DisableTraceMethod(IApplicationBuilder app)
        {
            ...
            {
                bool maxForwardExists = context.Request.Headers.MaxForwards.IsNullOrEmpty();
                if (((context.Request.Method == "TRACE" || context.Request.Method == "OPTIONS") && maxForwardExists)
