...
watch(areHospitalVisitsLoading, () => {
    emit("on-is-loading-changed", areHospitalVisitsLoading.value);
});
...
<template>
    <div>
        <div>
            <section>
                <v-row v-if="isEmpty && !areHospitalVisitsLoading">
                ...
                <HgDataTableComponent
                    ...
                    :loading="areHospitalVisitsLoading"
                    :items="items"
                    :fields="fields"
                    density="compact"
