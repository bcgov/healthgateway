...
namespace HealthGateway.WebClient.Test.Services
{
    ...
    public class UserProfileService_Test
    {
        ...
        public async void ShouldQueueNotificationUpdate()
        {
            ...
            // Execute
            RequestResult<UserProfileModel> actualResult = await service.CreateUserProfile(new CreateUserRequest() { Profile = userProfile }, DateTime.Today).ConfigureAwait(true);
        ...
        public async Task ShouldValidateAgeAsync()
        {
            ...
            PrimitiveRequestResult<bool> actualResult = await service.ValidateMinimumAge(hdid).ConfigureAwait(true);
            Assert.Equal(ResultType.Success, actualResult.ResultStatus);
