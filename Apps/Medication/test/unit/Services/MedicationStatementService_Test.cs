...
namespace HealthGateway.Medication.Test
{
    ...
    public class MedicationService_Test
    {
        ...
        public async Task ValidProtectiveWord()
        {
            ...
            Mock<IHNClientDelegate> hnClientDelegateMock = new Mock<IHNClientDelegate>();
            hnClientDelegateMock.Setup(s => s.GetMedicationStatementsAsync(phn, protectiveWord, It.IsAny<string>(), ipAddress)).ReturnsAsync(new HNMessage<List<MedicationStatement>>(new List<MedicationStatement>()));
