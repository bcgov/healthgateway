...
namespace HealthGateway.Database.Migrations
{
    ...
    [Migration("20211028175602_VPAddAssetEndpoint")]
    partial class VPAddAssetEndpoint
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HealthGateway.Database.Models.VaccineProofRequestCache", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasColumnName("VaccineProofRequestCacheId");

                    b.Property<string>("AssetEndpoint")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("ProofTemplate")
                        .IsRequired()
                        .HasColumnType("character varying(15)");

                    b.Property<string>("ShcImageHash")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("VaccineProofResponseId")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasAlternateKey("PersonIdentifier", "ProofTemplate", "ShcImageHash");

                    b.HasIndex("ProofTemplate");

                    b.ToTable("VaccineProofRequestCache");
                });

            modelBuilder.Entity("HealthGateway.Database.Models.VaccineProofTemplateCode", b =>
                {
                    ...
                    b.ToTable("VaccineProofTemplateCode");

                    b.HasData(
                        new
                        {
                            TemplateCode = "BCProvincial",
                            CreatedBy = "System",
                            CreatedDateTime = new DateTime(2019, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("HealthGateway.Database.Models.WalletConnection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasColumnName("WalletConnectionId");
                    ...
                    b.Property<DateTime?>("DisconnectedDateTime")
                        .HasColumnType("timestamp without time zone");

                    b.Property<string>("InvitationEndpoint")
                        .HasColumnType("text");
                    ...
                    b.ToTable("WalletConnection");
                });

            modelBuilder.Entity("HealthGateway.Database.Models.WalletConnectionStatusCode", b =>
                {
                    b.Property<string>("StatusCode")
                        .HasMaxLength(15)
                        .HasColumnType("character varying(15)");
                    ...
                    b.ToTable("WalletConnectionStatusCode");
            ...
            modelBuilder.Entity("HealthGateway.Database.Models.WalletCredential", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasColumnName("WalletCredentialId");
                    ...
                    b.Property<Guid>("WalletConnectionId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("WalletConnectionId");

                    b.ToTable("WalletCredential");
                });

            modelBuilder.Entity("HealthGateway.Database.Models.WalletCredentialStatusCode", b =>
                {
                    b.Property<string>("StatusCode")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)");
                    ...
                    b.ToTable("WalletCredentialStatusCode");
            ...
            modelBuilder.Entity("HealthGateway.Database.Models.VaccineProofRequestCache", b =>
                {
                    b.HasOne("HealthGateway.Database.Models.VaccineProofTemplateCode", null)
                        .WithMany()
                        .HasForeignKey("ProofTemplate")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("HealthGateway.Database.Models.WalletConnection", b =>
                {
                    b.HasOne("HealthGateway.Database.Models.WalletConnectionStatusCode", null)
                        .WithMany()
            ...
            modelBuilder.Entity("HealthGateway.Database.Models.WalletCredential", b =>
                {
                    b.HasOne("HealthGateway.Database.Models.WalletCredentialStatusCode", null)
                        .WithMany()
                        .HasForeignKey("Status")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HealthGateway.Database.Models.WalletConnection", "WalletConnection")
                        .WithMany("Credentials")
                        .HasForeignKey("WalletConnectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("WalletConnection");
                });
