...
{
    public partial class AddInAppCommsType : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[] { "InApp", "System", new DateTime(2019, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "In-App communication type", "System", new DateTime(2019, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });
...
DECLARE
    ...
    BEGIN
        ...
        THEN
            data = row_to_json(NEW);
            send = true;
        ELSEIF(TG_OP = 'DELETE' and OLD.""CommunicationTypeCode"" = 'Banner')
        THEN
            data = row_to_json(OLD);
            send = true;
        END IF;
