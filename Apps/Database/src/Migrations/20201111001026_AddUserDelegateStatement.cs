...
{
    public partial class AddUserDelegateStatement : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "UserDelegateStatement",
                schema: "gateway",
                columns: table => new
                {
                    ...
                    TestDate = table.Column<DateTime>(maxLength: 52, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserDelegateStatement", x => new { x.OwnerId, x.DelegateId });
                });
        }
