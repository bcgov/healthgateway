...
namespace HealthGateway.Database.Events
{
    ...
    public class UserProfileEventConsumer
    {
        ...
        public void OnUserLoggedIn(object? sender, UserLoggedInEventArgs args)
        {
            DbResult<UserProfile> result = this.userProfileDelegate.UpdateAsync(args.UserProfile, ct: args.CancellationToken).GetAwaiter().GetResult();
