...
namespace HealthGateway.Patient.Test
{
    ...
    public class PatientService_Test
    {
        ...
        {
            GetPatientPHN(new Dictionary<string, string>(), Database.Constants.DBStatusCode.Created, false);
        }

        [Fact]
        public void ShouldGetPatientPHNWitEmptyResult()
        {
            GetPatientPHN(new Dictionary<string, string>(), Database.Constants.DBStatusCode.Created, true);
        }
        ...
        private static void GetPatientPHN(Dictionary<string, string> configDictionary, Database.Constants.DBStatusCode mockDBStatusCode, bool returnNullPatientResult)
        {
            RequestResult<PatientModel> requestResult = new RequestResult<PatientModel>()
            {
                ResultStatus = Common.Constants.ResultType.Success,
