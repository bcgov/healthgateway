...
namespace HealthGateway.GatewayApi.Services
{
    ...
    public interface IMessagingVerificationService
    {
        ...
        /// <param name="ct"><see cref="CancellationToken"/> to manage the async request.</param>
        /// <returns>A messaging verification model.</returns>
        Task<MessagingVerification> AddEmailVerificationAsync(string hdid, string email, bool isEmailVerified, Guid inviteKey, bool shouldCommit = true, CancellationToken ct = default);
