...
namespace HealthGateway.GatewayApiTests.Services.Test
{
    ...
    public class DataAccessServiceTests
    {
        ...
        [InlineData(true)]
        [InlineData(false)]
        public async Task ShouldGetBlockedDatasets(bool blockedDatasetsExists)
        {
            // Arrange
        ...
        public async Task ShouldGetContactInfo(bool profileEmailExists, bool profileSmsExists, bool verificationEmailExists, bool verificationSmsExists)
        {
            // Arrange
        ...
        [InlineData(false, SubjectHdid, NotDelegatedHdid)] // returns false for protected subject because subject is not protected and delegate is invalid
        public async Task ShouldGetUserProtection(bool isSubjectProtected, string subjectHdid, string delegateHdid)
        {
            // Arrange
