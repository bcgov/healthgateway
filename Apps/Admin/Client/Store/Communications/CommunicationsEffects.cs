...
public class CommunicationsEffects
{
    ...
    public async Task HandleAddAction(CommunicationsActions.AddAction action, IDispatcher dispatcher)
    {
        ...
        try
        {
            RequestResult<Communication> response = await this.Api.Add(action.Communication).ConfigureAwait(true);
    ...
    public async Task HandleLoadAction(IDispatcher dispatcher)
    {
        ...
        try
        {
            RequestResult<IEnumerable<Communication>> response = await this.Api.GetAll().ConfigureAwait(true);
            if (response.ResultStatus == ResultType.Success)
            {
    ...
    public async Task HandleUpdateAction(CommunicationsActions.UpdateAction action, IDispatcher dispatcher)
    {
        ...
        try
        {
            RequestResult<Communication> response = await this.Api.Update(action.Communication).ConfigureAwait(true);
            if (response.ResultStatus == ResultType.Success)
            {
    ...
    public async Task HandleDeleteAction(CommunicationsActions.DeleteAction action, IDispatcher dispatcher)
    {
        ...
        try
        {
            RequestResult<Communication> response = await this.Api.Delete(action.Communication).ConfigureAwait(true);
            if (response.ResultStatus == ResultType.Success)
            {
