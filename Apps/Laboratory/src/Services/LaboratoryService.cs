...
namespace HealthGateway.Laboratory.Services
{
    ...
    public class LaboratoryService : ILaboratoryService
    {
        ...
        /// <inheritdoc/>
        public async Task<RequestResult<IEnumerable<PhsaCovid19Order>>> GetCovid19Orders(string hdid, int pageIndex = 0)
        {
            ...
            if (httpContext != null)
            {
                ...
                if (accessToken != null)
                {
                    ...
                    if (delegateResult.ResultStatus == ResultType.Success)
                    {
                        ...
                        retVal.ResourcePayload = PhsaCovid19Order.FromPHSAModelList(delegateResult.ResourcePayload);
