...
namespace HealthGateway.LaboratoryTests.Delegates
{
    ...
    public class LaboratoryDelegateTests
    {
        ...
        {
            const string expectedPhn = "9735361200";
        ...
        /// <returns>A <see cref="Task"/> representing the asynchronous unit test.</returns>
        [Fact]
        public async Task GetCovid19OrdersHandlesApiException()
        {
            const HttpStatusCode statusCode = HttpStatusCode.InternalServerError;
            string expectedMessage = $"Status: {statusCode}. Error while retrieving Covid19 Orders";

            // Arrange
            Mock<ILogger<RestLaboratoryDelegate>> mockLogger = new();
            ApiException mockException = MockRefitExceptionHelper.CreateApiException(statusCode, HttpMethod.Get);
            Mock<ILaboratoryApi> mockLaboratoryApi = new();
        ...
        /// <summary>
        /// GetCOvid19Orders handles no content.
        /// </summary>
        /// <returns>A <see cref="Task"/> representing the asynchronous unit test.</returns>
        [Fact]
        public async Task GetCovid19OrdersHandlesNoContent()
        {
            const int expectedCount = 0;

            // Arrange
            PhsaResult<List<PhsaCovid19Order>>? response = null;

            Mock<ILogger<RestLaboratoryDelegate>> mockLogger = new();
            Mock<ILaboratoryApi> mockLaboratoryApi = new();
            mockLaboratoryApi.Setup(
                    s => s.GetCovid19OrdersAsync(
                        It.IsAny<string>(),
                        It.IsAny<string>(),
                        It.IsAny<string>(),
            ...
            // Verify
            Assert.Equal(ResultType.Success, actualResult.ResultStatus);
            Assert.Equal(expectedCount, actualResult.TotalResultCount);
        ...
        /// <returns>A <see cref="Task"/> representing the asynchronous unit test.</returns>
        [Fact]
        public async Task GetCovid19OrdersHandlesHttpRequestException()
        {
        ...
        /// <summary>
        /// Get Covid19 Laboratory Report handles no content.
        /// </summary>
        /// <returns>A <see cref="Task"/> representing the asynchronous unit test.</returns>
        [Fact]
        public async Task GetLabReportHandlesNoContent()
        {
            const int expectedCount = 0;
            string expectedMessage = $"Status: {(int)HttpStatusCode.NoContent}. Error retrieving Laboratory Report.";
            LaboratoryReport? laboratoryReport = null;

            // Arrange
            Mock<ILaboratoryApi> mockLaboratoryApi = new();
            mockLaboratoryApi.Setup(s => s.GetLaboratoryReportAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<CancellationToken>()))!.ReturnsAsync(laboratoryReport);
        ...
        /// <returns>A <see cref="Task"/> representing the asynchronous unit test.</returns>
        [Fact]
        public async Task GetLabReportHandlesHttpRequestException()
        {
        ...
        /// Get Lab Report.
        /// </summary>
        /// <param name="isCovid19">The bool value indicating whether report is covid19 or not.</param>
        /// <returns>A <see cref="Task"/> representing the asynchronous unit test.</returns>
        [Theory]
        [InlineData(true)]
        [InlineData(false)]
        public async Task ShouldGetLabReport(bool isCovid19)
        {
            string expectedPdf =
            ...
            // Act
            RequestResult<LaboratoryReport> actualResult = await labDelegate.GetLabReportAsync(ReportId, Hdid, AccessToken, isCovid19);
        ...
        /// <summary>
        /// Get Lab Report handles ApiException.
        /// </summary>
        /// <returns>A <see cref="Task"/> representing the asynchronous unit test.</returns>
        [Fact]
        public async Task GetLabReportHandlesApiException()
        {
            const HttpStatusCode statusCode = HttpStatusCode.InternalServerError;
            string expectedMessage = $"Status: {statusCode}. Error retrieving Laboratory Report";
        ...
        public async Task ShouldGetLaboratorySummary()
        {
            ...
            PhsaResult<PhsaLaboratorySummary> response = new()
            {
                ...
                Result = new() { LabOrderCount = 1, LabOrders = [new()] },
            };
            ...
            Assert.Equal(ResultType.Success, actualResult.ResultStatus);
            Assert.Equal(expectedCount, actualResult.TotalResultCount);
            Assert.Equal(expectedCount, actualResult.ResourcePayload?.Result?.LabOrderCount);
        }
        ...
        /// <returns>A <see cref="Task"/> representing the asynchronous unit test.</returns>
        [Fact]
        public async Task GetLaboratorySummaryHandlesApiException()
        {
            const HttpStatusCode statusCode = HttpStatusCode.InternalServerError;
            string expectedMessage = $"Status: {statusCode}. Error while retrieving Laboratory Summary";
        ...
        /// <summary>
        /// GetLaboratorySummary handles no content.
        /// </summary>
        /// <returns>A <see cref="Task"/> representing the asynchronous unit test.</returns>
        [Fact]
        public async Task GetLaboratorySummaryHandlesNoContent()
        {
            const int expectedCount = 0;

            // Arrange
            PhsaResult<PhsaLaboratorySummary>? response = null;

            Mock<ILogger<RestLaboratoryDelegate>> mockLogger = new();
            Mock<ILaboratoryApi> mockLaboratoryApi = new();
            mockLaboratoryApi.Setup(
                    s => s.GetPlisLaboratorySummaryAsync(
                        It.IsAny<string>(),
                        It.IsAny<string>(),
                        It.IsAny<CancellationToken>()))!
                .ReturnsAsync(response);
            ...
            Assert.Equal(ResultType.Success, actualResult.ResultStatus);
            Assert.Equal(expectedCount, actualResult.TotalResultCount);
            Assert.Null(actualResult.ResourcePayload?.Result?.LabOrders);
        }
        ...
        /// <returns>A <see cref="Task"/> representing the asynchronous unit test.</returns>
        [Fact]
        public async Task GetLaboratorySummaryHandlesHttpRequestException()
        {
