...
describe("Filters", () => {  
    ...
    it("Validate Filter Counts", () => {
        ...
        cy.get("[data-testid=NoteCount]")
            .should("be.visible")
            .contains(countRegex);
        cy.get("[data-testid=SpecialAuthorityRequestsCount]")
            .should("be.visible")
            .contains(countRegex);
    ...
    it("Filter Immunization", () => {
        ...
        cy.get("[data-testid=specialauthorityrequestsTitle]").should("not.exist");
    ...
    it("Filter Special Authority", () => {
        ...
        cy.get("[data-testid=filterDropdown]").click();
        cy.get('[data-testid=filterContainer]').contains("Clear").click();
        cy.get("[data-testid=SpecialAuthorityRequests-filter]").click({ force: true });
        cy.get('[data-testid=btnFilterApply]').click();
        ...
        cy.get("[data-testid=medicationTitle]").should("not.exist");
        cy.get("[data-testid=laboratoryTitle]").should("not.exist");
        cy.get("[data-testid=specialauthorityrequestsTitle]").should("be.visible");
        verifyActiveFilter('1');
    });
    ...
    it("Validate Apply and Cancel buttons", () => {
        ...
        cy.get("[data-testid=SpecialAuthorityRequests-filter]").should("not.to.be.checked");
        cy.get('[data-testid=btnFilterApply]').click();
        cy.get('[data-testid=filterContainer]').should("not.exist");
        ...
        cy.get("[data-testid=SpecialAuthorityRequests-filter]").should("be.checked");
        cy.get('[data-testid=btnFilterCancel]').click();
        cy.get('[data-testid=filterContainer]').should("not.exist");
    ...
    it("Validate disabled filters", () => {
        ...
        cy.get("[data-testid=SpecialAuthorityRequestsCount]").should("not.exist");
        cy.get('[data-testid=btnFilterCancel]').click();
    });
});
