resource "keycloak_oidc_identity_provider" "bcsc_mobile" {
  ...
  sync_mode                     = "FORCE"
  authorization_url             = "${var.keycloak_idp_bcsc_mobile.base_url}${var.keycloak_idp_bcsc_mobile.auth_path}"
  login_hint                    = true
  token_url                     = "${var.keycloak_idp_bcsc_mobile.base_url}${var.keycloak_idp_bcsc_mobile.token_path}"
  backchannel_supported         = false
  user_info_url                 = "${var.keycloak_idp_bcsc_mobile.base_url}${var.keycloak_idp_bcsc_mobile.userinfo_path}"
  client_id                     = var.keycloak_idp_bcsc_mobile.client_id
  client_secret                 = var.keycloak_idp_bcsc_mobile.client_secret
  issuer                        = "${var.keycloak_idp_bcsc_mobile.base_url}${var.keycloak_idp_bcsc_mobile.issuer_path}"
  default_scopes                = "openid profile email"
  validate_signature            = true
  jwks_url                      = "${var.keycloak_idp_bcsc_mobile.base_url}${var.keycloak_idp_bcsc_mobile.jwks_path}"
  extra_config = {
