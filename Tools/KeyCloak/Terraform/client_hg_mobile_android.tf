resource "keycloak_openid_client" "hg_mobile_android_client" {
  realm_id                     = data.keycloak_realm.hg_realm.id
  client_id                    = var.client_hg_mobile_android.id
  name                         = "Health Gateway Mobile Android - ${var.environment.name}"
  description                  = "Health Gateway Mobile Android applications"
  enabled                      = true
  access_type                  = "PUBLIC"
...
resource "keycloak_openid_client_default_scopes" "hg_mobile_android_client_default_scopes" {
  realm_id  = data.keycloak_realm.hg_realm.id
...
resource "keycloak_openid_client_optional_scopes" "hg_mobile_android_client_optional_scopes" {
  realm_id  = data.keycloak_realm.hg_realm.id
  client_id = keycloak_openid_client.hg_mobile_android_client.id
...
resource "keycloak_generic_role_mapper" "hg_mobile_android_uma" {
  realm_id  = data.keycloak_realm.hg_realm.id
  client_id = keycloak_openid_client.hg_mobile_android_client.id
  role_id   = data.keycloak_role.Uma_authorization.id
}

resource "keycloak_openid_user_attribute_protocol_mapper" "hg_mobile_android_hdid" {
  realm_id            = data.keycloak_realm.hg_realm.id
  client_id           = keycloak_openid_client.hg_mobile_android_client.id
  name                = "hdid"
  user_attribute      = "hdid"
...
resource "keycloak_openid_user_attribute_protocol_mapper" "hg_mobile_android_auth_method" {
  realm_id            = data.keycloak_realm.hg_realm.id
  client_id           = keycloak_openid_client.hg_mobile_android_client.id
  name                = "AuthMethod"
  user_attribute      = "idp"
...
resource "keycloak_openid_audience_protocol_mapper" "hg_mobile_android_audience" {
  realm_id                 = data.keycloak_realm.hg_realm.id
  client_id                = keycloak_openid_client.hg_mobile_android_client.id
